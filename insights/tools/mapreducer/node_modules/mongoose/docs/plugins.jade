...
block content
  ...
  h3#next Next Up
  :markdown
    Now that we've covered plugins and how to get involved in the great community growing around them, let's take a look how you can help [contribute](https://github.com/LearnBoost/mongoose/blob/master/CONTRIBUTING.md) to the continuing development of Mongoose itself.
