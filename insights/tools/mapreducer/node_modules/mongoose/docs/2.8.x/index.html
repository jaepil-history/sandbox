<html>
  <head>
    ...
    <style>
      body {
        background: url('/docs/2.8.x/images/bg.png');
        padding: 0 30px 30px;
        margin-top: 0;
      }

      #wrap {
        background: url('/docs/2.8.x/images/pattern.png') no-repeat -134px -211px;
        min-height: 600px;
        padding-top: 30px;
      }
      ...
      h1 a {
        background: url('/docs/2.8.x/images/logo.png');
        width: 404px;
        height: 47px;
        margin-bottom: 40px;
        text-indent: -500em;
  ...
  <body>
    ...
    <div id="wrap">
      <div id="page">
        ...
        <div id="content">
          <h1>Mongoose 2.8.x</h1>

<div id="announce"><strong>08-23-2012: Mongoose 2.8 is out</strong> with a few bug fixes, a couple of which cause a slight change in behavior from previous 2.x versions.
  Check out the <a href="https://groups.google.com/d/topic/mongoose-orm/UVx4xdufz-I/discussion">release notes</a> for details.
</div>
...
<p>THE SOFTWARE IS PROVIDED 'AS IS', WITHOUT WARRANTY OF ANY KIND,<br />EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO THE WARRANTIES OF<br />MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE AND NONINFRINGEMENT.<br />IN NO EVENT SHALL THE AUTHORS OR COPYRIGHT HOLDERS BE LIABLE FOR ANY<br />CLAIM, DAMAGES OR OTHER LIABILITY, WHETHER IN AN ACTION OF CONTRACT,<br />TORT OR OTHERWISE, ARISING FROM, OUT OF OR IN CONNECTION WITH THE<br />SOFTWARE OR THE USE OR OTHER DEALINGS IN THE SOFTWARE.</p>
        ...
        <div id="footer">
          ...
          <form action="http://groups.google.com/group/mongoose-orm/boxsubscribe">
           <a href="http://groups.google.com/group/mongoose-orm" id="google-subscribe-link"><img src="/docs/2.8.x/images/groups.png" border="0"></a>
