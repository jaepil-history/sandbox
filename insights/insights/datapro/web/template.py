...
from insights.datapro.web.settings import TEMPLATES_DIR
from insights.datapro.utils.dates import utc_unixtime_to_localtime
from insights.datapro.web.libs.jinja2htmlcompress import SelectiveHTMLCompress
...
def progress_width_percent(percent, container_type='full'):
    ...
    try:
        ...
        progress_width = 0 # Don't break the datapro
