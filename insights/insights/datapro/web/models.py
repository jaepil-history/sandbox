...
from insights.datapro.backends.mongodb import MongoBackend
...
class BaseModel(object):
    ...
    def __init__(self):
        ...
        #  os.environ['DATAPRO_ENV'] = 'test'
        if getenv('DATAPRO__ENV', None) == 'test':
            self.mongo.database = 'datapro_test'
...
class DashboardModel(BaseModel):
    ...
    def get_last_system_check(self, active_system_checks):
        ...
        for check in active_system_checks:
            ...
            # don't break the datapro if the daemon is stopped
            try:
...
class SystemModel(BaseModel):
    ...
    Example: 
        active_checks = ['cpu'] will get everything in the collection datapro_cpu, between date_from and date_to
    """
